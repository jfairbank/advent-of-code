  ...
  describe "Day 4" $ do
    describe "puzzle1" $ do
      it "solves the example input" $ do
        Day04.puzzle1 exampleInput `shouldBe` 13

      it "solves the puzzle input" $ do
        Day04.puzzle1 puzzleInput `shouldBe` 21959

    describe "puzzle2" $ do
      it "solves the example input" $ do
        Day04.puzzle2 exampleInput `shouldBe` 30

      it "solves the puzzle input" $ do
        Day04.puzzle2 puzzleInput `shouldBe` 5132675
