  ...
  describe "Day 3" $ do
    describe "puzzle1" $ do
      it "solves the example input" $ do
        Day03.puzzle1 exampleInput `shouldBe` 157

      it "solves the puzzle input" $ do
        Day03.puzzle1 puzzleInput `shouldBe` 7997

    describe "puzzle2" $ do
      it "solves the example input" $ do
        Day03.puzzle2 exampleInput `shouldBe` 70

      it "solves the puzzle input" $ do
        Day03.puzzle2 puzzleInput `shouldBe` 2545
